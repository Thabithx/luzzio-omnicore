...
export function Home() {
   ...
   return (
      <div className="min-h-screen bg-white">
         ...
         <section className="h-[70vh] flex items-center justify-center bg-brand-grey relative overflow-hidden">
            <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
               <h2 className="text-[15vw] md:text-[20vw] font-black uppercase tracking-[-0.05em] text-black/5 leading-none px-10">LUZZIO</h2>
            </div>
            <div className="relative text-center space-y-12 max-w-2xl px-10">
               <h3 className="text-4xl font-black uppercase tracking-tighter leading-tight">
                  Uncompromising <br /> Modernity.
               </h3>
               <Link to="/products" className="inline-block text-small-brand border-b border-black pb-2 hover:opacity-50">
                  Discover Now
               </Link>
            </div>
         </section>
         ...
         <section className="py-40 bg-white flex flex-col items-center justify-center space-y-12 text-center px-10">
            <div className="space-y-4">
               <p className="text-small-brand text-gray-400 font-bold tracking-[0.3em]">Corporate Excellence</p>
               <h2 className="text-4xl font-black uppercase tracking-tighter">Sustainability & Ethics</h2>
            </div>
            <p className="max-w-xl text-sm text-gray-600 font-medium leading-relaxed uppercase tracking-widest">
            ...
            <Link to="/products" className="text-small-brand border-b border-black pb-1 font-black">Learn More</Link>
         </section>
      </div>
   );
}
